...
pub struct DynamicGlobalProperties {
    ...
    pub confidential_supply: Option<Supply>,
    pub init_hbd_supply: Supply,
    pub current_hbd_supply: Supply,
    pub confidential_hbd_supply: Option<Supply>,
    ...
    pub sps_fund_percent: Option<u64>,
    pub sps_interval_ledger: Option<Supply>,
    pub downvote_pool_percent: u64,
    pub smt_creation_fee: Option<Supply>,
}
